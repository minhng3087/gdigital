...
<section class="content">
    <div class="box">
        ...
        <div class="box-body">
        	<form name="frmAdd" method="post" action="<?php echo route('backend.news.postAdd'); ?>" enctype="multipart/form-data">
        		<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>" />
                  ...
                  <?php if(@$_GET['type']=='gioi-thieu'): ?>
                    <div class="form-group <?php if($errors->first('types')!=''): ?> has-error <?php endif; ?>">
                                  ...
                                  <div class="box box-solid">
                                    ...
                                    <div class="box-body no-padding">
                                      <ul class="nav nav-pills nav-stacked">
                                        ...
                                        <li><a href="backend/news?type=<?php echo e(@$_GET[type]); ?>"><i class="fa fa-trash-o"></i> Thoát</a></li>
                                      </ul>
                                    </div>
                                    <!-- /.box-body -->
                                  </div>
