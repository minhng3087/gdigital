...
<?php $__env->startSection('controller','Tìm kiếm sản phẩm'); ?>
        ...
        <div class="box-body">
          ...
          <table id="example1" class="table table-bordered table-hover">
              ...
              <tr>
                ...
                <td>
                   <img style="max-width: 100px;" src="<?php echo e(asset('upload/product/'.$item->photo)); ?>" onerror="this.src='<?php echo e(asset('public/admin_assets/images/no-image.jpg')); ?>'" style="max-width: 100%;max-height: 200px;"  alt="NO PHOTO" />
                </td>
               <td class="text-center with_dieuhuong">
                  ...
                  <div class="form-group" > 
                    <?php if($item->noibat>0): ?>
                      <a href="backend/product/edit?id=<?php echo e($item->id); ?>&noibat=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Nổi bật(Home)</a>
                    <?php else: ?>
                      <a href="backend/product/edit?id=<?php echo e($item->id); ?>&noibat=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> No Nổi bật(Home)</a>
                    <?php endif; ?>
                  </div>
