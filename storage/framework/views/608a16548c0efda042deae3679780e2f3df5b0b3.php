                ...
                <div class="row">
                   <?php
                    ...
                    foreach($cate2 as $cate){
                        $list=Products::select('name','name_eg','name_uae','name_tai','alias','id','mota','mota_eg','mota_uae','mota_tai','photo','created_at')->where('cate_id',$cate['id'])->where('status',1)->limit(6)->orderBy('id','desc')->get()->toArray();
                   ?> 
                    <div class="col-md-4">
                        <div class="market-item">
                            ...
                            <a href="<?php echo e(asset(@$cate['alias'].'.htm')); ?>" title="<?php echo $cate['name'.$duoi]; ?>" class="effect view-link" title="">Xem thêm</a>
                        </div>
                    </div>
                 <?php } ?>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 no-mobile">
                                        <div class="news-list-ul">
                                            <h5 class="text-uppercase"><a href="" title="">TIN TỨC - SỰ KIỆN NỔI BẬT</a> </h5>
                                            <ul>
                                                <?php
                        ...
                        foreach($cate2 as $cate){
                            $list=Products::select('name','alias','id','mota','photo','created_at','pricesale','price')->where('cate_id',$cate['id'])->where('status',1)->limit(6)->orderBy('id','desc')->get()->toArray();
                       ?> 
            ...
            <div class="container">
                ...
                <div id="view" class="row">
                   <?php
                    ...
                    $page_cate=$page*12;
                    @$list_post_parent=Products::select('name','name_eg','name_uae','name_tai','alias','id','mota','photo','created_at')->where('cate_id',$catpro['id'])->where('status',1)->limit($page_cate)->orderBy('id','desc')->get()->toArray();
                ...
                <div class="row">
                    <div class="col-md-9">
                        <section class="news-cate-child">
                            ...
                            <div class="news-gr">
                              <?php
                                @$list_post_parent=Products::select('name','name_eg','name_uae','name_tai','alias','id','mota','mota_eg','mota_uae','mota_tai','photo','created_at')->where('cate_id',$catpro['id'])->where('status',1)->orderBy('id','desc')->paginate(12);
                            ...
                            <div class="child-defe">
                                ...
                                <div class="news-item mgt-20">
                                   <?php
                                    ...
                                    @$post_new_right=Products::select('name','name_eg','name_uae','name_tai','alias','id','mota','mota_eg','mota_uae','mota_tai','photo','created_at')->whereIn('cate_id',$id_arr)->where('status',1)->orderBy('id','desc')->limit(4)->get();
