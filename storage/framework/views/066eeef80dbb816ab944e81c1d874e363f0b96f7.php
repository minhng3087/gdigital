            ...
            <tbody>
              ...
              <tr>
                ...
                <span style="text-align: right;float: right;">
                    ...
                    <?php else: ?>
                      <a href="backend/catenew/edit?id=<?php echo e($item->id); ?>&menu=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> No Menu Top</a>
                    <?php endif; ?>
                </span>
                </td>
                ...
                <td class="text-center with_dieuhuong">
                  ...
                  <?php if($item->noibat>0): ?>
                    <a href="backend/catenew/edit?id=<?php echo e($item->id); ?>&noibat=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Dự án (Home)</a>
                  <?php else: ?>
                    <a href="backend/catenew/edit?id=<?php echo e($item->id); ?>&noibat=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Dự án (Home)</a>
                  <?php endif; ?>  
                  <div style="height: 5px;"></div>
                  <?php if($item->bot>0): ?>
