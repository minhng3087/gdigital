								...
								<div class="repeater" id="repeater">
											...
											<?php if(!empty($data->link_footer)): ?>
												...
												<?php if(!empty($content->tags)): ?>
													<?php $__currentLoopData = $content->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														...
														<?php echo $__env->make('backend.repeater.row-link-footer-category', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
					                ...
					                <div class="text-right">
					                    <button class="btn btn-primary" 
							            	onclick="repeater(event,this,'<?php echo e(route('get.layout')); ?>','.index', 'link-footer-category', '.link-footer-category')">Thêm
							            </button>
					                </div>
					            </div>
							</div>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\m\resources\views/backend/category/create-edit.blade.php ENDPATH**/ ?>