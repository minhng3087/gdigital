           ...
           <table id="example1" class="table table-bordered table-striped"> 
            ...
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                  ...
                  <div class="form-group"> 
                    <?php if($item->status>0): ?>
                      <a href="backend/product/edit?id=<?php echo e($item->id); ?>&hienthi=<?php echo e(time()); ?>&type=<?php echo e(@$_GET['type']); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Hiển thị</a>
                    <?php else: ?>
                      <a href="backend/product/edit?id=<?php echo e($item->id); ?>&hienthi=<?php echo e(time()); ?>&type=<?php echo e(@$_GET['type']); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Không Hiển thị</a>
                    <?php endif; ?>
                  </div>
                  <div class="form-group " > 
                    <?php if($item->hot>0): ?>
                      <a href="backend/product/edit?id=<?php echo e($item->id); ?>&hot=<?php echo e(time()); ?>&type=<?php echo e(@$_GET['type']); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i>Home</a>
                    <?php else: ?>
                      <a href="backend/product/edit?id=<?php echo e($item->id); ?>&hot=<?php echo e(time()); ?>&type=<?php echo e(@$_GET['type']); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Tắt Home</a>
                    <?php endif; ?>
                  </div>
                  <div class="form-group " > 
                    <?php if($item->noibat>0): ?>
                      <a href="backend/product/edit?id=<?php echo e($item->id); ?>&noibat=<?php echo e(time()); ?>&type=<?php echo e(@$_GET['type']); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i>Nổi bật</a>
                    <?php else: ?>
                      <a href="backend/product/edit?id=<?php echo e($item->id); ?>&noibat=<?php echo e(time()); ?>&type=<?php echo e(@$_GET['type']); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Tắt Nổi bật</a>
                    <?php endif; ?>
                  </div>
                ...
                <td class="text-center with_dieuhuong">
                  <i class="fa fa-pencil fa-fw"></i><a href="backend/product/edit?id=<?php echo e($item->id); ?>&type=<?php echo e(@$_GET['type']); ?>">Edit</a>
                </td>
                <td class="text-center">
                  <i class="fa fa-trash-o fa-fw"></i><a onClick="if(!confirm('Xác nhận xóa')) return false;" href="backend/product/<?php echo e($item->id); ?>/delete?type=<?php echo e(@$_GET['type']); ?>">Delete</a>
                </td>
            ...
            <div class="box-footer col-md-12">
                  <div class="row">
                    <div class="col-md-6">
                      <input type="button" onclick="javascript:window.location='backend/product/add?type=<?php echo e(@$_GET['type']); ?>'" value="Thêm" class="btn btn-primary" />
