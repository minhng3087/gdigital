            ...
            <tbody>
              ...
              <tr>
                ...
                <span style="text-align: right;float: right;">
                    <?php if($item->menu>0): ?>
                      <a href="backend/productcate/edit?id=<?php echo e($item->id); ?>&menu=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Menu Top</a>
                    <?php else: ?>
                      <a href="backend/productcate/edit?id=<?php echo e($item->id); ?>&menu=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> No Menu Top</a>
                    <?php endif; ?>
                </span>
                ...
                <td class="text-center with_dieuhuong">
                  ...
                  <?php if($item->status>0): ?>
                    <a href="backend/productcate/edit?id=<?php echo e($item->id); ?>&hienthi=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Bật</a>
                  <?php else: ?>
                    <a href="backend/productcate/edit?id=<?php echo e($item->id); ?>&hienthi=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Tắt</a>
                  <?php endif; ?>
                  <div style="height: 5px;"></div>
                 <div class="hidden">
                     <?php if($item->bot>0): ?>
                        <a href="backend/productcate/edit?id=<?php echo e($item->id); ?>&bot=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Menu (bottom)</a>
                      <?php else: ?>
                        <a href="backend/productcate/edit?id=<?php echo e($item->id); ?>&bot=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Menu (bottom)</a>
                      <?php endif; ?>  
                 </div>
                </td>
                ...
                <td class="text-center with_dieuhuong">
                  ...
                  <i class="fa fa-pencil fa-fw"></i><a href="backend/productcate/edit?id=<?php echo e($item->id); ?>">Edit</a>

                </td>

                <td class="text-center">

                  <i class="fa fa-trash-o fa-fw"></i><a onClick="if(!confirm('Xác nhận xóa')) return false;" href="backend/productcate/<?php echo e($item->id); ?>/delete">Delete</a>
