...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#xoahet").click(function(){
      ...
      if (hoi==true) document.location = homeUrl()+"/backend/specification/"+listid+"/delete_list";
    });
  });
</script>
<script type="text/javascript">
    function changepos() {
        document.frm1.action = "backend/specification/changepos";
      ...
      <div class="box">
              ...
              <tr>
                ...
                <td class="text-center with_dieuhuong">
                  ...
                  <?php if($item->status>0): ?>
                    <a href="backend/specification/edit?id=<?php echo e($item->id); ?>&hienthi=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Bật</a>
                  <?php else: ?>
                    <a href="backend/specification/edit?id=<?php echo e($item->id); ?>&hienthi=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Tắt</a>
                  <?php endif; ?>

                </td>
                <td class="text-center with_dieuhuong">
                 <i class="fa fa-pencil fa-fw"></i><a href="backend/specification/edit?id=<?php echo e($item->id); ?>">Edit</a>
                </td> 
                <td class="text-center with_dieuhuong">

                 
                  <i class="fa fa-trash-o fa-fw"></i><a onClick="if(!confirm('Xác nhận xóa')) return false;" href="backend/specification/<?php echo e($item->id); ?>/delete">Delete</a>  
                </td>
        ...
        <div class="box-footer col-md-12">
          ...
          <div class="col-md-6">
            ...
            <input type="button" onclick="javascript:window.location='backend/specification/add'" value="Thêm" class="btn btn-primary" />
