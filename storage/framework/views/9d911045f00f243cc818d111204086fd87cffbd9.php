	                ...
	                <div class="tab-content">
                                   ...
                                   <div class="box-body no-padding">
                                      <ul class="nav nav-pills nav-stacked">
                                         ...
                                         <!----------------------------------------->
                                          ...
                                          ?> 
                                             <li id="nhan-menu" >
                                                <label class="click_view" data-id="<?=$row->id;?>"><input value="<?php echo e($row->id); ?>" type="radio" name="txtProductCate[]" /> <?php echo e($row->name); ?></label>
                                                <ul class="children">
                                                    <?php
                                                    ...
                                                    ?>    
                                                    <li id="nhan-menu" ><label class="click_view" data-id="<?=$rows->id;?>"><input value="<?php echo e($rows->id); ?>" type="radio" name="txtProductCate[]" /> <?php echo e($rows->name); ?></label>
                                                        <ul class="children">
                                                        <?php  foreach($cat_post3 as $item){ ?>
                                                            <li id="nhan-menu" ><label class="click_view" data-id="<?=$item->id;?>"><input value="<?php echo e($item->id); ?>" type="radio" name="txtProductCate[]" /> <?php echo e($item->name); ?></label></li>
                                                        <?php } ?>
                                                        </ul>
                                                    </li>
                                                    <?php } ?>
                        ...
                        <div class="tab-pane" id="tab_6">
                                ...
                                <div class="form-group">
							      	...
							      	<textarea name="mota_ja" rows="5" class="form-control"></textarea>
                             ...
                             <div class="form-group">
							      	...
							      	<input type="text" name="title_ja"  maxlength="255"  class="form-control" />
