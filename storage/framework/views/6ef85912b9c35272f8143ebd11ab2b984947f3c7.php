                                  ...
                                  <div class="box box-solid">
                                    ...
                                    <div class="box-body no-padding">
                                      <ul class="nav nav-pills nav-stacked">
                                        ...
                                        <li style="display: none;"><a style="line-height: 35px;"><input type="text" placeholder="Tag (Từ khóa tách nhau bằng dấu ',')" name="txtTag" class="form-control" style="width: 100%;margin-right: 10px;float: left;margin-bottom: 10px;"/> Tag(Từ khóa tách nhau bằng dấu ",")</a><div style="clear: both;"></div></li> 
                                        <li style="display: none;"><a><select name="txtSao" class="form-control">
