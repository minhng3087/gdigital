                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <div class="news-list-ul">
                            ...
                            <h5 class="text-uppercase"><a href="tin-tuc.html" title=""><?= $tintucsukien?></a> </h5>
        ...
        <?php 
            $data_pro = ProductCate::select()->where('status',1)->where('home',1)->get()->toArray();
             foreach($data_pro as $rows){
                ...
                $post_laodong=Products::select('name','name_eg','name_uae','name_tai','id','alias','photo','created_at')->whereIn('cate_id',$ids)->where('status',1)->orderBy('stt','desc')->limit(8)->get()->toArray();
