...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#xoahet").click(function(){
      ...
      if (hoi==true) document.location = homeUrl()+"/backend/productrelative/"+listid+"/deleteList";
...
<script type="text/javascript">
    function changepos() {
        document.frm1.action = "backend/productrelative/changepos";
               ...
               <td class="text-center with_dieuhuong">
                  ...
                  <div class="form-group"> 
                    <?php if($item->status>0): ?>
                      <a href="backend/productrelative/edit?id=<?php echo e($item->id); ?>&hienthi=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Hiển thị</a>
                    <?php else: ?>
                      <a href="backend/productrelative/edit?id=<?php echo e($item->id); ?>&hienthi=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> No Hiển thị</a>
                    <?php endif; ?>
                  ...
                  <div class="form-group" > 
                    ...
                    <?php if($item->hot>0): ?>
                      ...
                      <a href="backend/productrelative/edit?id=<?php echo e($item->id); ?>&hot=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Trái</a>

                    <?php else: ?>

                      <a href="backend/productrelative/edit?id=<?php echo e($item->id); ?>&hot=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Trái</a>
                ...
                <td class="text-center with_dieuhuong">
                  ...
                  <i class="fa fa-pencil fa-fw"></i><a href="backend/productrelative/edit?id=<?php echo e($item->id); ?>">Edit</a>

                </td>

                <td class="text-center">

                  <i class="fa fa-trash-o fa-fw"></i><a onClick="if(!confirm('Xác nhận xóa')) return false;" href="admin/productrelative/<?php echo e($item->id); ?>/delete">Delete</a>
        ...
        <div class="box-footer col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input type="button" onclick="javascript:window.location='backend/productrelative/add'" value="Thêm" class="btn btn-primary" />
