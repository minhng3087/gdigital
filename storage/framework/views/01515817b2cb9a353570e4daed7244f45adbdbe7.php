...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
        	...
        	<form method="post" name="frmEditProduct" action="backend/productrelative/edit?id=<?php echo e($id); ?>" enctype="multipart/form-data">
	                  	...
	                  	<div class="tab-pane active" id="tab_1">
	                  		...
	                  		<div class="row">
                                 ...
                                 <!---------------- right ------------>
                                      ...
                                      <div class="box box-solid">
                                        ...
                                        <div class="box-body no-padding">
                                          <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li><a href="<?php echo e(url('backend/productrelative')); ?>"><i class="fa fa-trash-o"></i> Thoát</a></li>
                                          </ul>
                                        </div>
                                        <!-- /.box-body -->
                                      </div>
                                      ...
                                      <div class="box box-solid">
                                        <div class="box-header with-border">
                                          <h3 class="box-title">Danh mục liên quan</h3>
                                        ...
                                        <div class="box-body no-padding">
                                          <ul class="nav nav-pills nav-stacked">
                                             ...
                                             <!----------------------------------------->
                                              <?php 
                                               $cate= explode(',',$data->relative_cate);
                                            
                                                
                                                
                                              $cat_post= DB::table("product_categories")->select('id','name','display')->where('display',1)->get();foreach($cat_post as $row){
