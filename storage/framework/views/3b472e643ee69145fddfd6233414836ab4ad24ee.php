		        		...
		        		<div class="row">
		        			<div class="col-lg-6">
	                			<div class="form-group">
	                				...
	                				<input type="text" name="content[driver]" class="form-control" value="<?php echo e(@$content->driver); ?>" placeholder="smtp">
	                			</div>
	                			<div class="form-group">
	                				<label for="">Mail host</label>
	                				<input type="text" name="content[host]" class="form-control" value="<?php echo e(@$content->host); ?>" placeholder="smtp.gmail.com">
	                			</div>
	                			<div class="form-group">
	                				<label for="">Mail port</label>
	                				<input type="text" name="content[port]" class="form-control" value="<?php echo e(@$content->port); ?>" placeholder="587">
	                			</div>
	                			<div class="form-group">
	                				<label for="">Mail encryption</label>
	                				<input type="text" name="content[encryption]" class="form-control" value="<?php echo e(@$content->encryption); ?>" placeholder="tls">
	                			</div>
	                			<div class="form-group">
