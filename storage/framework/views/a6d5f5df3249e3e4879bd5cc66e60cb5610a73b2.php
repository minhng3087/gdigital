                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-7 flex-center-between find-cv">
                                        ...
                                        <select class="style-input" name="career">
                                            ...
                                            <option <?php if($_SESSION['career']==$item['id']): ?> selected <?php endif; ?> value="<?php echo e($item['id']); ?>"><?php echo e($career->getNameCareer($item['id'],$duoi)); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                        </select>
                                        <div class="search">
                                                <input type="text" value="<?php if(isset($_SESSION['key'])): ?> <?php echo e($_SESSION['key']); ?> <?php endif; ?>" name="txtSearch" placeholder="Tìm tên ứng viên">
