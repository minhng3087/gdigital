...
<section class="content">
    <div class="box">
        ...
        <div class="box-body">
      	<form method="post" name="frmEditProduct" action="backend/product/edit?id=<?php echo e($id); ?>&type=<?php echo e(@$_GET['type']); ?>" enctype="multipart/form-data">
                                 ...
                                 <!---------------- right ------------>
                                      ...
                                      <div class="box box-solid">
                                        ...
                                        <div class="box-body no-padding">
                                          <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li><a href="<?php echo e(url('backend/product?type='.@$_GET['type'])); ?>"><i class="fa fa-trash-o"></i> Thoát</a></li>
                                          </ul>
                                        </div>
                                        <!-- /.box-body -->
                                      </div>
                                  ...
                                  <div class="box box-solid">
                                    ...
                                    <div class="box-body no-padding">
                                      <ul class="nav nav-pills nav-stacked">
                                        <li id="right-col-li" >
                                        <img src="<?php echo e(asset('upload/product/'.$data->photo3)); ?>" id="output" />
