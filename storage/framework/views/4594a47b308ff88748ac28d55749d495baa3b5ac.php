               ...
               <td class="text-center with_dieuhuong">
                 <div class="form-group"> 
                   <?php if($item->status>0): ?>
                     <a href="backend/lienket/edit?id=<?php echo e($item->id); ?>&hienthi=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Hiển thị</a>
                   <?php else: ?>
                     <a href="backend/lienket/edit?id=<?php echo e($item->id); ?>&hienthi=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Hiển thị</a>
                   <?php endif; ?>
                 </div>
               </td>
               <td class="text-center with_dieuhuong"><?php echo e($item->stt); ?></td>
               <td class="text-center with_dieuhuong">
                 <i class="fa fa-pencil fa-fw"></i><a href="backend/lienket/edit?id=<?php echo e($item->id); ?>">Edit</a>
               </td>
               <td class="text-center">
                 <i class="fa fa-trash-o fa-fw"></i><a onClick="if(!confirm('Xác nhận xóa')) return false;" href="backend/lienket/<?php echo e($item->id); ?>/delete">Delete</a>
               </td>
             </tr>
