        ...
        <div class="box-body">
          <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td><input type="checkbox" name="chon" id="chon" value="<?php echo e($item->mskh); ?>" class="chon" /></td>
                <td class="text-center with_dieuhuong"><?php echo e($item->mskh); ?></td>
                <td><?php echo e($item->name); ?></td>
                <td><a href="<?php echo URL::route('backend.customers.show',$item->mskh); ?>">Xem</a></td>
                <td class="text-center with_dieuhuong">
                  <div class="form-group"> 
                    <?php if($item->status>0): ?>
                      <a href="backend/customers/edit?mskh=<?php echo e($item->mskh); ?>&hienthi=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Hiển thị</a>
                    <?php else: ?>
                      <a href="backend/customers/edit?mskh=<?php echo e($item->mskh); ?>&hienthi=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Hiển thị</a>
                    <?php endif; ?>
                  </div>
                </td>
                <td class="text-center with_dieuhuong">
                  <i class="fa fa-pencil fa-fw"></i><a href="backend/customers/edit?mskh=<?php echo e($item->mskh); ?>">Edit</a>
                </td>
