        	...
        	<form name="frmAdd" method="post" action="<?php echo route('backend.catenew.postAdd'); ?>" enctype="multipart/form-data">
                                          ...
                                          <ul class="nav nav-pills nav-stacked">
                                            <li><a style="font-weight: 400px;">
                                              <select class="form-control select2" style="width: 100%;" name="views">
                                                ...
                                                <option value="1">Quy trình thi công</option>
                                                <option value="2">Dự án</option>
                                                <option value="3">Hỗ trợ kỹ thuật</option>
                                                <option value="4">Kinh nghiệm xây nhà</option>
                                            </select>
                                            </a></li>
			    ...
			    <div class="col-md-6">
			    	...
			    	<div class="form-group">
					      ...
					      <input type="number" min="1" name="stt" value="<?php echo count($parent)+1; ?>" class="form-control" style="width: 100px;">
