            ...
            <tbody>
              ...
              <tr>
                ...
                <span style="text-align: right;float: right;">
                    <?php if($item->menu>0): ?>
                      <a href="backend/productcate/edit?id=<?php echo e($item->id); ?>&menu=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Hiển thị</a>
                    <?php else: ?>
                      <a href="backend/productcate/edit?id=<?php echo e($item->id); ?>&menu=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> No Hiển thị</a>
                    <?php endif; ?>
                </span>
