                                        ...
                                        <div class="box-body no-padding">
                                          <ul class="nav nav-pills nav-stacked">
                                             ...
                                             <!----------------------------------------->
                                              ...
                                              ?>  
                                                 <li id="nhan-menu" >
                                                    <label class="click_view" data-id="<?=$row->id;?>" pr-id="<?=$data->id;?>"><input <?php foreach($cate as $value){if($value == $row->id){echo 'checked';} }?> value="<?php echo e($row->id); ?>" type="radio" name="txtProductCate[]" /> <?php echo e($row->name); ?></label>
                                                    <ul class="children">
                                                        <?php
                                                        ...
                                                        ?>    
                                                        <li id="nhan-menu" ><label class="click_view" data-id="<?=$rows->id;?>" pr-id="<?=$data->id;?>"><input <?php foreach($cate as $value){if($value == $rows->id){echo 'checked';} }?> value="<?php echo e($rows->id); ?>" type="radio" name="txtProductCate[]" /> <?php echo e($rows->name); ?></label>
                                                            <ul class="children">
                                                            <?php  foreach($cat_post3 as $item){ ?>
                                                                <li id="nhan-menu" ><label class="click_view" data-id="<?=$item->id;?>" pr-id="<?=$data->id;?>"><input <?php foreach($cate as $value){if($value == $item->id){echo 'checked';} }?> value="<?php echo e($item->id); ?>" type="radio" name="txtProductCate[]" /> <?php echo e($item->name); ?></label>
                                                            <?php } ?>
                                                            </ul>
                                                        </li>
                                                        <?php } ?>
                                       ...
                                       <div class="box-body no-padding">
                                          <ul class="nav nav-pills nav-stacked">
                                             ...
                                             <!----------------------------------------->
                                                  <div id="load_view">
                                                     <?php 
                                                        $relat=explode(',',$data->relationship);
                                                        foreach($data_min as $row){
                                                    ?> 
                                                        <li id="nhan-menu" >
                                                        <label class="selectit"><input <?php foreach($relat as $rel){if($rel == $row->id){echo 'checked';}}?> value="<?php echo e($row->id); ?>" type="checkbox" name="relationship[]" /> <?php echo e($row->name); ?></label>
                                                        </li>
                                                    <?php } ?>   
