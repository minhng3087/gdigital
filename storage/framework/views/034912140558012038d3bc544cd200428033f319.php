<aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview" >
          ...
          <ul class="treeview-menu">
            ...
            <li class="hidden"><a href="backend/project"><i class="fa fa-circle-o"></i> <span>Dự án</span></a></li>
          </ul>
       ...
       <li><a href="backend/lienket?type=chat-luong"><i class="fa fa-circle-o"></i>Chất lượng </a></li>
      ...
      <li style="display: none;"><a href="backend/lienket?type=ly-do"><i class="fa fa-circle-o"></i>Lý do chọn chúng tôi</a></li>  
