                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="news-detail">
                             ...
                             <ul>
                             <?php
                                if(!empty($product_detail['relationship'])){
                             ?>
                                 <?php
                                    $lienquan=explode(',',$product_detail['relationship']);                                 
                                    foreach($lienquan as $k=>$ik){
                                      $item= Products::select('name','name_eg','id','alias')->where('status',1)->where('id',$ik)->first()->toArray();
                                 ?> 
                                    <li>
                            ...
                            <div class="child-defe">
                                ...
                                <div class="news-item mgt-20">
                                 ...
                                 ?>  
                                    ...
                                    <p class="desc"><?php echo _substr($item['mota'.$duoi],210)?></p>
