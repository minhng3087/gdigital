        ...
        <?php 
            ...
            $data_pro = ProductCate::select()->where('status',1)->where('home',1)->get()->toArray();
             ...
             foreach($data_pro as $rows){
                ...
                $post_laodong=Products::select('name','name_eg','name_uae','name_tai','name_ja','id','alias','photo','created_at','mota')->whereIn('cate_id',$ids)->where('status',1)->orderBy('stt','desc')->limit(8)->get()->toArray();
                      ...
                      <?php foreach($post_laodong as $item){?>  
                        <div class="col-md-3 mgt-20">
                            <div class="news-item">
                                ...
                                <p><?php echo _substr($item['mota'],170)?></p>
                            </div>
                        </div>
                     <?php } ?>   
                    </div>
