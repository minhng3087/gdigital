                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="civils">
                            ...
                            <div class="cv-list">
                                <h1 class="title-cate">Danh sách CV đã chọn</h1>
                                <div class="row">
                                    <?php $__currentLoopData = $result_cv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_chon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php 
                                        $user_profile = DB::table('user_profile')->select()->where('user_id',Auth::guard('customer')->user()->id)->where('profile_id',$item_chon->profile_id)->first();
