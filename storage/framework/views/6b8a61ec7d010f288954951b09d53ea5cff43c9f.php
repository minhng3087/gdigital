        ...
        <div class="box-body">
        	...
        	<form method="post" action="backend/lienket/edit?id=<?php echo e($id); ?>&type=<?php echo e(@$_GET['type']); ?>" enctype="multipart/form-data">
        		...
        		<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>" />
      			...
      			<div class="row">
              		...
              		<div class="col-md-8 col-xs-12">
                        ...
                        <?php }?>
                      	<div class="form-group <?php if(@$_GET['type'] != "quang-cao"){echo 'hidden';}?>">
						...
						<?php if($_GET['type']=='ly-do' || $_GET['type']=='post-videos' || @$_GET['type'] == "y-kien-khach-hang" || @$_GET['type'] == "chat-luong"): ?>
                ...
                <div class="col-md-3">
                      ...
                      <!-- /. box -->
                      <?php if($_GET['type']!='ly-do' && $_GET['type']!='post-videos' && @$_GET['type'] != "y-kien-khach-hang"): ?>
                      <div class="box box-solid">
                        <div class="box-header with-border">
                        ...
                        <div class="box-body no-padding">
                          <ul class="nav nav-pills nav-stacked">
                            <li>
                                <a><span><input type="radio" name="display" value="1" <?php if(@$data->display == 1){echo 'checked';}?> /> Trái</span></a>
                                <a><span><input type="radio" name="display" value="2" <?php if(@$data->display == 2){echo 'checked';}?>/> Chân trang bài viết</span></a>
                            </li>
