...
<section class="content">
    <div class="box">
        ...
        <div class="box-body">
        	<form name="frmAdd" method="post" action="<?php echo route('backend.specification.postAdd'); ?>" enctype="multipart/form-data">
                                                  ...
                                                  <div id="li-cate-admin">  
                                                     <!----------------------------------------->
                                                      <?php 
                                                       ...
                                                       ?>  
                                                         <li id="nhan-menu" >
                                                            <label class="selectit"><input value="<?php echo e($item->id); ?>" type="checkbox" name="cate_id[]" /> <?php echo e($item->name); ?> <span>(<?php echo @$product->name?>)</span></label>
                                                         </li>
                                                      <?php } ?>      
                                                      <!----------------------------------------->
                                                     </div>
