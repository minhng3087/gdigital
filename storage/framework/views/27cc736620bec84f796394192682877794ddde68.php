        ...
        <div class="box-body">
        	...
        	<form method="post" action="backend/lienket/edit?id=<?php echo e($id); ?>&type=<?php echo e(@$_GET['type']); ?>" enctype="multipart/form-data">
                ...
                <div class="col-md-3">
                      ...
                      <!-- /. box -->
                      <?php if($_GET['type']!='ly-do' && $_GET['type']!='post-videos' && @$_GET['type'] != "doi-tac" && @$_GET['type'] != "recument"): ?>
                      <div class="box box-solid">
                        <div class="box-header with-border">
                        ...
                        <div class="box-body no-padding">
                          <ul class="nav nav-pills nav-stacked">
                            <li>
                                ...
                                <a><span><input type="radio" name="display" value="2" <?php if(@$data->display == 2){echo 'checked';}?>/> Right detail New</span></a>
                                <a><span><input type="radio" name="display" value="3" <?php if(@$data->display == 3){echo 'checked';}?>/> Right detail chung</span></a>
                            </li>
