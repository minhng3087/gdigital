        		...
        		<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>" />
      			<div class="nav-tabs-custom">
	                <ul class="nav nav-tabs">
                        ...
                        <li class="hidden"><a href="#tab_2" data-toggle="tab" aria-expanded="true">Thông số kỹ thuật</a></li>
                                  ...
                                  <div class="box box-solid">
                                    ...
                                    <div class="box-body no-padding">
                                      <ul class="nav nav-pills nav-stacked">
                                        ...
                                        <li >
                                            <a style="font-weight: 400px;"><label><input type="checkbox" name="tinhtrang" <?php if($data->tinhtrang >=1){?> checked="checked" <?php } ?>/> Còn hàng</label></a>
                                        </li>
                                        <li >
                                            <a style="font-weight: 400px;"><label><input type="checkbox" name="status" <?php if($data->status >=1){?> checked="checked"<?php } ?>/> Hiển thị</label></a>
                                        </li>
                                        ...
                                        <li><a style="line-height: 35px;"><input placeholder="Tag (Từ khóa tách nhau bằng dấu ',')" type="text" name="txtTag" value="<?php echo e($data->tags); ?>" class="form-control" style="width: 100%;margin-right: 10px;float: left;margin-bottom: 10px;"/> Tag(Từ khóa tách nhau bằng dấu ",")</a><div style="clear: both;"></div></li>
                                        <li><a><select name="txtSao" class="form-control">
        								      		<option value="0">Chọn sao</option>
        								      		<?php for($i=0;$i<=5;$i++){   ?>      
                                                     <option value="<?php echo e($i); ?>" <?php if($data->sao ==  $i){echo 'selected';}?>><?php echo e($i); ?> sao</option>
                                                    <?php } ?>   
        								      	</select>
                                            </a>
                                        </li>
