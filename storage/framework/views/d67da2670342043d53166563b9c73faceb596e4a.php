...
<section class="content">
    <div class="box">
        ...
        <div class="box-body">
        	...
        	<form name="frmAdd" method="post" action="<?php echo route('backend.productrelative.postAdd'); ?>" enctype="multipart/form-data">
                                  ...
                                  <div class="box box-solid">
                                    ...
                                    <div class="box-body no-padding">
                                      <ul class="nav nav-pills nav-stacked">
                                         ...
                                         <!----------------------------------------->
                                          <?php $cat_post= DB::table("product_categories")->select('id','name','display')->where('display',1)->get();foreach($cat_post as $row){
