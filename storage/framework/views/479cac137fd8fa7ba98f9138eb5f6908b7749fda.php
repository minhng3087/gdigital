  ...
  <body class="hold-transition register-page">
    <div class="register-box">
      ...
      <div class="register-box-body">
        ...
        <form action="<?php echo route('postRegister'); ?>" name="frmRegister" method="post">
			...
			<div class="form-group has-feedback <?php if($errors->first('name')!=''): ?> has-error <?php endif; ?>">
          	...
          	<div class="form-group has-feedback <?php if($errors->first('email')!=''): ?> has-error <?php endif; ?>">
	            <input type="email" class="form-control" name="email" placeholder="Email">
	            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
	            <?php if($errors->first('email')!=''): ?>
	            <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> <?php echo $errors->first('email');; ?></label>
	            <?php endif; ?>
          	</div>
          	...
          	<div class="form-group has-feedback <?php if($errors->first('repassword')!=''): ?> has-error <?php endif; ?>">
	            ...
	            <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> <?php echo $errors->first('repassword');; ?></label>
	            <?php endif; ?>
          	</div>
          	<div class="row">
	            <div class="col-xs-8">
