        		...
        		<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>" />
      			...
      			<div class="nav-tabs-custom">
	                ...
	                <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_11" data-toggle="tab" aria-expanded="false">Thông tin (Japan)</a></li>
                        ...
                        <li><a href="#tab_12" data-toggle="tab" aria-expanded="false">Thông tin detail (Jpan)</a></li>
                         ...
                         <div class="tab-pane" id="tab_11">
	                  		...
	                  		<div class="box box-info">
				                ...
				                <div class="box-header">
				                  	...
				                  	<h3 class="box-title">Thông tin Bottom(Japan)</h3>
				                ...
				                <div class="box-body pad">
				        			...
				        			<textarea name="content_ja" id="txtContent" cols="50" rows="5"><?php echo e($data->content_ja); ?></textarea>
                        ...
                        <div class="tab-pane" id="tab_12">
	                  		...
	                  		<div class="box box-info">
				                ...
				                <div class="box-header">
				                  	...
				                  	<h3 class="box-title">Thông tin Detail(Japan)</h3>
				                ...
				                <div class="box-body pad">
				        			...
				        			<textarea name="slogan_ja" id="txtContent" cols="50" rows="5"><?php echo e($data->slogan_ja); ?></textarea>
