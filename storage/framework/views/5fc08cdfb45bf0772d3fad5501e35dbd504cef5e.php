	                  		...
	                  		<div class="row">
		                  		...
		                  		<div class="col-md-8 col-xs-12">
                                    ...
                                    <div class="box box-info">
        				                ...
        				                <div class="box-body pad">
        				        			<textarea name="txtContent2" id="txtContent" cols="50" rows="5"></textarea>
        				        		</div>
        				        	</div>
                                                    ...
                                                    <ul class="children">
                                                        ...
                                                        <li id="nhan-menu" ><label class="selectit"><input value="<?php echo e($rows->id); ?>" type="checkbox" name="txtProductCate[]" /> <?php echo e($rows->name); ?></label>
                                                            ...
                                                            <?php  foreach($cat_post3 as $item){ ?>
                                                                <li id="nhan-menu" ><label class="selectit"><input value="<?php echo e($item->id); ?>" type="checkbox" name="txtProductCate[]" /> <?php echo e($item->name); ?></label></li>
                                                            <?php } ?>
                                                            </ul>
                                                        </li>
                                                        <?php } ?>
