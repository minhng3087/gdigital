				...
				<div class="col-sm-9">
					<div class="nav-tabs-custom">
		                ...
		                <ul class="nav nav-tabs">
		                    ...
		                    <li  <?php if(session('active_tab')=='cau-hinh-seo'): ?> class="active" <?php endif; ?> data-tab="cau-hinh-seo" style="display: none;">
		                    	<a href="#setting" data-toggle="tab" aria-expanded="true">Cấu hình seo</a>
		                    </li>
		                    <li  <?php if(session('active_tab')=='tags'): ?> class="active" <?php endif; ?> data-tab="tags" style="display: none;">
		                ...
		                <div class="tab-content">
							                    ...
							                    <tbody>
							                        ...
							                        <?php $__currentLoopData = $productsGift; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							                            <tr>
							                                ...
							                                <td><?php echo strip_tags($item->desc); ?></td>
							                                <td>
							                                    <div>
		                    ...
		                    <?php endif; ?>
		                    <div class="tab-pane <?php if(session('active_tab')=='cau-hinh-seo'): ?> active <?php endif; ?>" id="setting">
		                    	<div class="form-group">
			                    ...
			                    <?php if(isUpdate(@$module['action'])): ?>
				                    ...
				                    <div class="google-preview">
				                        ...
				                        <div class="google__url">
				                            <?php echo e(asset( 'san-pham/'.$data->slug.'-'.$data->id )); ?>
		                    ...
		                    <div class="tab-pane <?php if(session('active_tab')=='tags'): ?> active <?php endif; ?>" id="tags">
		                    	<?php if(isUpdate(@$module['action'])): ?>
					...
					<div class="box box-success">
		                ...
		                <div class="box-body">
		                    <div class="form-group">
		                        ...
		                        <label class="custom-checkbox">
									<?php if(isUpdate(@$module['action'])): ?>
										<input type="checkbox" name="is_price_shock" value="1" <?php echo e(@$data->is_price_shock == 1 ? 'checked' : null); ?>> Sản phẩm mới
									<?php else: ?>
								...
								<label class="custom-checkbox">
									<?php if(isUpdate(@$module['action'])): ?>
										<input type="checkbox" name="is_selling" value="1" <?php echo e(@$data->is_selling == 1 ? 'checked' : null); ?>> Sản phẩm trả góp 0%
									<?php else: ?>
								...
								<label class="custom-checkbox">
									<?php if(isUpdate(@$module['action'])): ?>
										<input type="checkbox" name="is_online" value="1" <?php echo e(@$data->is_online == 1 ? 'checked' : null); ?>> Sản phẩm chỉ bán online
									<?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\m\resources\views/backend/products/create-edit.blade.php ENDPATH**/ ?>