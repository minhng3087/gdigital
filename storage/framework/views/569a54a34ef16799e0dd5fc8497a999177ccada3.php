<aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="backend/productrelative"><i class="fa fa-circle-o"></i> <span>Bài viết liên quan sản phẩm</span></a></li>
          </ul>
        </li>
        ...
        <li class="treeview" >
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="backend/project"><i class="fa fa-circle-o"></i> <span>Dự án</span></a></li>
          </ul>
       ...
       <li><a href="backend/slider?type=hinh-anh"><i class="fa fa-circle-o"></i> <span>Quản lý slider</span></a></li>
        ...
        <li class="treeview" >
          ...
          <a href="#"> <i class="fa fa-edit"></i> <span>Về chúng tôi</span> <i class="fa fa-angle-left pull-right"></i></a>

          <ul class="treeview-menu">
            <li>
                 <a href="backend/about/edit?type=ve-chung-toi">
                    <i class="fa fa-picture-o" aria-hidden="true"></i> <span>Về chúng tôi</span>
                  </a>
            </li>   
            <li><a href="backend/lienket?type=chat-luong"><i class="fa fa-circle-o"></i>Chất lượng của chúng tôi</a></li>
          </ul>
      ...
      <li><a href="backend/lienket?type=ly-do"><i class="fa fa-circle-o"></i>Lý do chọn chúng tôi</a></li>  
      <li><a href="backend/lienket?type=y-kien-khach-hang"><i class="fa fa-circle-o"></i>Ý kiến khách hàng</a></li>
       <li class="treeview">

          <a href="#">
            <i class="fa fa-gear" aria-hidden="true"></i> <span>Videos</span>
            <i class="fa fa-angle-left pull-right"></i>
          </a>

          <ul class="treeview-menu">
            <li><a href="backend/lienket?type=post-videos"><i class="fa fa-circle-o"></i>Bài viết videos</a></li>
            <li><a href="backend/about/edit?type=videos"><i class="fa fa-gear" aria-hidden="true"></i> Video</a></li>
          </ul>
