               ...
               <td class="text-center with_dieuhuong">
                  ...
                  <div class="form-group hidden" > 
                    ...
                    <?php if($item->exp>0): ?>
                      ...
                      <a href="backend/post/edit?id=<?php echo e($item->id); ?>&exp=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Kinh nghiệm slide</a>
                    ...
                    <?php else: ?>
                      ...
                      <a href="backend/post/edit?id=<?php echo e($item->id); ?>&exp=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Kinh nghiệm slide</a>
                  ...
                  <div class="form-group " > 
                    ...
                    <?php if($item->hot>0): ?>
                      ...
                      <a href="backend/post/edit?id=<?php echo e($item->id); ?>&hot=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Nổi bật</a>
                    ...
                    <?php else: ?>
                      ...
                      <a href="backend/post/edit?id=<?php echo e($item->id); ?>&hot=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Nổi bật</a>
                  ...
                  <div class="form-group" > 
                    <?php if($item->hotleft>0): ?>
                      <a href="backend/post/edit?id=<?php echo e($item->id); ?>&hotleft=<?php echo e(time()); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Liên quan</a>
                    <?php else: ?>
                      <a href="backend/post/edit?id=<?php echo e($item->id); ?>&hotleft=<?php echo e(time()); ?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Liên quan</a>
                    <?php endif; ?>
                  </div>
                ...
                <td class="text-center">
                  ...
                  <i class="fa fa-trash-o fa-fw"></i><a onClick="if(!confirm('Xác nhận xóa')) return false;" href="backend/post/<?php echo e($item->id); ?>/delete">Delete</a>
