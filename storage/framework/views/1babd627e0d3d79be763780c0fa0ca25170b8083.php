        ...
        <section class="breadcrumb">
            ...
            <div class="container">
                ...
                <ul class="flex-center-start">
                    ...
                    <li><a href="<?php echo e(url('/')); ?>" title=""><i class="fa fa-home"></i> <?php echo $home;?> </a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mgt-20">
                        ...
                        <div class="video-item relative">
                            ...
                            <a href="<?php echo e(asset(changeTitle($item['name'.$duoi]).'.'.$item['id'].'.html')); ?>"
                               title="<?php echo e($item['name'.$duoi]); ?>" class="effect">
                            ...
                            <span class="video-abs absolute"><img src="<?php echo e(asset('public/images/icon/icon-video.png')); ?>"
                                                                  alt="" title=""> </span>
