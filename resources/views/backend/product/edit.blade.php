                                 ...
                                 <!---------------- right ------------>
                                      ...
                                      <div class="box box-solid">
                                        ...
                                        <div class="box-body no-padding">
                                          <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li><a href="{{ url('backend/product?type='.@$_GET['type'])}}"><i class="fa fa-trash-o"></i> Thoát</a></li>
                                          </ul>
                                        </div>
                                        <!-- /.box-body -->
                                      </div>
                                  ...
                                  <!-- -->    
                                    ...
                                    <div class="box-body no-padding">
                                      <ul class="nav nav-pills nav-stacked">
                                        <li id="right-col-li" >
                                          		   <img src="{{ asset('upload/product/'.$data->photo) }}" id="output" />
                                  ...
                                  <div class="box box-solid">
                                    ...
                                    <div class="box-body no-padding">
                                      <ul class="nav nav-pills nav-stacked">
                                        <li id="right-col-li" >
                                        <img src="{{ asset('upload/product/'.$data->photo2) }}" id="output" />
                                  ...
                                  <div class="box box-solid">
                                    ...
                                    <div class="box-body no-padding">
                                      <ul class="nav nav-pills nav-stacked">
                                        <li id="right-col-li" >
                                        <img src="{{ asset('upload/product/'.$data->photo3) }}" id="output" />
