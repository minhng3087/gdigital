				...
				<div class="col-sm-9">
					<div class="nav-tabs-custom">
		                ...
		                <ul class="nav nav-tabs">
		                    ...
		                    <li  @if(session('active_tab')=='cau-hinh-seo') class="active" @endif data-tab="cau-hinh-seo" style="display: none;">
		                    	<a href="#setting" data-toggle="tab" aria-expanded="true">Cấu hình seo</a>
		                    </li>
		                    <li  @if(session('active_tab')=='tags') class="active" @endif data-tab="tags" style="display: none;">
...
@stop
@section('scripts')
	<script src="{{ url('public/admin_assets/plugins/datetimepicker/bootstrap-datepicker.min.js') }}"></script>
	<script>
