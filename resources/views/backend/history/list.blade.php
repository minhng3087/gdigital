...
<section class="content">
  <h2>Lịch sử khám của {{$customer->name}}</h2>
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
          ...
          <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center with_dieuhuong">{{$item->amount}}</td>
                <td class="text-center with_dieuhuong">{{$item->position}}</td>
                <td class="text-center with_dieuhuong">{{ date('d/m/Y', strtotime($item->day_action)) }}</td>
                <td class="text-center with_dieuhuong">{{$item->period}}</td>
                <td class="text-center with_dieuhuong">
                  <i class="fa fa-pencil fa-fw"></i><a href="backend/customers/show/{{$customer->mskh}}/edit?id={{$item->id}}">Edit</a>
                </td>
        ...
        <div class="box-footer col-md-12">
          <div class="row">
            <div class="col-md-6">
              <input type="button" onclick="javascript:window.location='backend/customers/show/{{@$customer->mskh}}/add'" value="Thêm" class="btn btn-primary" />
